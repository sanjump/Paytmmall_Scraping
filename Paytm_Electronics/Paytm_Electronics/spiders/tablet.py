...
class PaytmSpider(scrapy.Spider):
    name = 'paytmtablet'
    pageno=2
    start_urls=['https://paytmmall.com/tablets-glpid-7908?use_mw=1&src=store&from=storefront']
    def parse(self, response, **kwargs):
        ...
        page = 'https://paytmmall.com/tablets-glpid-7908?use_mw=1&src=store&from=storefront&page=' + str(PaytmSpider.pageno) + '&category=7908'
