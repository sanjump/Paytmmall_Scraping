...
class PaytmSpider(scrapy.Spider):
    name = 'paytmspeaker'
    pageno=2
    start_urls=['https://paytmmall.com/speakers-glpid-6455?use_mw=1&src=store&from=storefront']
    ...
    def parse(self, response, **kwargs):
        ...
        page = 'https://paytmmall.com/speakers-glpid-6455?use_mw=1&src=store&from=storefront&page=' + str(PaytmSpider.pageno) + '&category=6455'
