...
class PaytmSpider(scrapy.Spider):
    name = 'paytmmobile'
    pageno=2
    start_urls=['https://paytmmall.com/mobiles-glpid-6224?use_mw=1&src=store&from=storefront']
    ...
    def parse(self, response, **kwargs):
        ...
        page = 'https://paytmmall.com/mobiles-glpid-6224?use_mw=1&src=store&from=storefront&page=' + str(PaytmSpider.pageno) + '&category=6224'
