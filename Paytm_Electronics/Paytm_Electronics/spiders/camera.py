...
class PaytmSpider(scrapy.Spider):
    name = 'paytmcamera'
    pageno=2
    start_urls=['https://paytmmall.com/camera-sale-llpid-199745?discoverability=online&use_mw=1&src=store&from=storefront']
    ...
    def parse(self, response, **kwargs):
        ...
        #page = 'https://paytmmall.com/mobile-headphones-headsets-glpid-78654?use_mw=1&src=store&from=storefront&page=' + str(PaytmSpider.pageno) + '&category=78654'
        #if PaytmSpider.pageno <= 10:
